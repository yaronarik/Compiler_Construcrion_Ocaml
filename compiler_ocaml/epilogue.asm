...
.L_bin_apply_list:
      cmp r12, sob_nil
      je .L_bin_apply_list_end
      mov rdx, SOB_PAIR_CAR(r12)
      mov r12, SOB_PAIR_CDR(r12)
      push rdx
      inc r9
      jmp .L_bin_apply_list
.L_bin_apply_list_end:
      mov r15, r9
      dec r15
      mov rbx, 0
.L_bin_apply_list_args:
      cmp rbx, r15
      jge .L_bin_apply_list_args_end
      mov r11, qword [rsp + 8 * rbx]
      mov r10, qword [rsp + 8 * r15]
      mov qword [rsp + 8 * rbx], r10
      mov qword [rsp + 8 * r15], r11
      inc rbx
      dec r15
      jmp .L_bin_apply_list_args
.L_bin_apply_list_args_end:
      mov rbx, COUNT
      sub rbx, 2
      mov r15, rbx
.L_bin_apply_args:
      cmp rbx, 0
      je .L_bin_apply_args_end
      push PARAM(rbx) 
      dec rbx
      jmp .L_bin_apply_args
.L_bin_apply_args_end:
      mov rbx, r15
      add rbx, r9
      mov r12, rbx
      push rbx
      ...
      mov r11, r15
      mov rcx, rbx
.L_bin_apply_fix_stack:
      dec r15
      dec rcx
      mov r9, qword [rsp + 8 * rcx]
      mov qword [rbp + 8 * r15], r9
      cmp rcx, 0
      jne .L_bin_apply_fix_stack
      shl r11, 3
      add rsp, r11
      pop rbp
      jmp qword [rax + 1 + 8]
